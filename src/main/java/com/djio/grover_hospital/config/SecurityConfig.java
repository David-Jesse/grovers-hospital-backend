...
import com.djio.grover_hospital.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Public GET endpoints - homepage, services, blogs
                        .requestMatchers(HttpMethod.GET, "/departments/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/consultant-schedule/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/portal/account/export-data/*").permitAll()
